...
class ThreeLayerConvNet(object):
    ...
    def __init__(self, input_dim=(3, 32, 32), num_filters=32, filter_size=7,
        ...
        # 2nd layer = affine
        padd = (filter_size - 1) // 2 # see definition below
        stride = 1 # see definition below
        HH = (input_dim[1] + 2*padd - filter_size)//stride + 1
        WW = (input_dim[2] + 2*padd - filter_size)//stride + 1
        pool_stride = 2
        H = (HH - 2)//pool_stride + 1
        W = (WW - 2)//pool_stride + 1
    ...
    def loss(self, X, y=None):
        ...
        dx, grads['W1'], grads['b1'] = conv_relu_pool_backward(dout, CRP_cache)
        ############################################################################
        #                             END OF YOUR CODE                             #
        ############################################################################
